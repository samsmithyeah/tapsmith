...
const browser = await puppeteer.launch({ executablePath: '/Applications/Google Chrome.app/Contents/MacOS/Google Chrome', headless: 'new', timeout: 120000, protocolTimeout: 300000, args: ['--no-first-run', '--user-data-dir=/tmp/docs-shots-chrome-state'] });
