...
description: "Configure HTTPS interception on iOS simulators."
---
...
See the [iOS network capture on CI](/platform/ci-setup/#ios-network-capture-on-ci) section for `brew install mitmproxy` + SE approval on CI runners.
