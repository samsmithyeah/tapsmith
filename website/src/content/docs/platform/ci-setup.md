---
title: "CI Setup"
description: "Run Tapsmith tests in GitHub Actions and other CI environments."
---
...
See [iOS network capture](/platform/ios-network-capture/) for the full first-run walkthrough and troubleshooting.
