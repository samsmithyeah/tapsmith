...
description: "Test hybrid apps by switching between native and web contexts."
---
...
If your app is fully native, you do not need this. Stick with the standard [Selectors Guide](/guides/selectors/) and native locators.
...
- [API Reference](/reference/api/locators/) -- full method signatures and options.
- [Selectors Guide](/guides/selectors/) -- choosing the right locators for native UI.
- [Configuration](/reference/configuration/) -- global timeout and project settings.
