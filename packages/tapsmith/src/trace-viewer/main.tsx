...
style.textContent = `
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  /* Log/Console tab */
  .log-entry { font-family: 'SF Mono', 'Cascadia Code', Consolas, monospace; font-size: 11px; padding: 1px 12px; display: flex; gap: 8px; line-height: 1.6; }
  ...
  .con-search { flex: 1; min-width: 140px; padding: 4px 8px; background: var(--color-bg); border: 1px solid var(--color-border); border-radius: 3px; color: var(--color-text-secondary); font-size: 12px; outline: none; font-family: 'SF Mono', 'Cascadia Code', Consolas, monospace; }
